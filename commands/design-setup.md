...
Most of the Claude Design Suite is pure guidance and needs **no install** — you can plan, design, write code, and review immediately. Only these power features touch a real browser and therefore need a one-time dependency install:
